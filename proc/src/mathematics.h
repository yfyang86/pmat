...
inline double logit_f_ex(double x, double a){return log((x+a)*(1-a)/(1-(x+a)*(1-a)));}
double foldednomal(double *a, int m, double *b, int n );
double foldednomalpvalue(double *a, int m, double *b, int n, bool logit, double logittuning, bool nonZero);
// Orginal meteline:
...
double mannwhitneyPvalue(double u, Uint m, Uint n, double ***CDF, Uint maxm, Uint maxn, int  nonZeroPairs);
